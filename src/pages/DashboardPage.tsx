                ...
                <div className="flex flex-grow overflow-hidden">
                    ...
                    `}>
                        ...
                        <nav className="flex-grow mt-4 px-4 space-y-2 overflow-y-auto">
                            <a className="flex items-center gap-4 px-3.5 py-3 rounded-lg text-sm font-medium transition-all bg-gradient-to-r from-[#00FFB0]/10 to-transparent border-l-[3px] border-[#00FFB0] text-[#00FFB0]" href="#">
                                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z" /></svg>
                                {sidebarOpen && <span>Resumen</span>}
                            </a>
                            <Link to="/ecofactur" className="flex items-center gap-4 px-3.5 py-3 rounded-lg text-gray-400 hover:text-[#00FFB0] hover:bg-white/5 text-sm font-medium transition-all">
